...
parser = argparse.ArgumentParser(description='Process evaluation results for WildBench.')
parser.add_argument('action', type=str, choices=['pairwise-gpt4t', 'pairwise-llama', 'pairwise-haiku', 'score', 'score-sonnet'], 
                    help='The type of evaluation to perform')
parser.add_argument('--gpt_eval_name', type=str, default="gpt-4.1-mini",
                    help='Name of the GPT evaluator model')
parser.add_argument('--k', type=int, default=-1,
                    help='Margin for pairwise length comparison. Default: -1')
...
ACTION = args.action
K = args.k  # for pairwise length margin
...
if ACTION == "pairwise-gpt4t":
    ...
    folder = FOLDER+"/score.v2/eval="+args.gpt_eval_name+"/"
    MODE = "score"
